defmodule NapoProfitTest do
  ...
  test "sample 1: generic single-company profit decline" do
    problem =
      "Our company's profit declined 35% this year. Build a complete root-cause analysis: every driver decomposed to concrete checkable causes with the specific data you would pull for each."
  ...
  test "sample 2: retail chain profit decline" do
    problem =
      "A retail chain experienced a 40% profit decline. Analyze complete root causes: revenue drivers, cost pressures, inventory issues, operational inefficiencies with specific data sources and metrics for each."
  ...
  test "sample 3: tech company margin compression" do
    problem =
      "A technology company saw profit margins compress by 25% while revenue grew 10%. Identify all drivers: revenue quality decline, cost structure inflation, mix shifts, operational inefficiencies. Provide concrete metrics and data sources for each."
