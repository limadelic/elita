defmodule Tape.Writer do
  ...
  def next_idx(cassette_key, agent) do
    get_and_update(__MODULE__, &advance_agent_idx(&1, {cassette_key, agent}))
  end

  defp advance_agent_idx(state, ptr_key) do
    idx = Map.get(state, ptr_key, 0)
    {idx, Map.put(state, ptr_key, idx + 1)}
  end
